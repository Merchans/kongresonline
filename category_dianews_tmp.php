							...
							foreach ($adverts as $advert) {
								...
								?>
										...
										<div class="chi-theme-card">
											...
											<div class="card-body chi-card-body">
												<div class="text-left"><a href="<?php echo get_permalink($advert->ID) ?>" class="chi-name--min-title"><?php echo $advert->post_title ?></a>
												</div>
												<strong class="chi-name-title">
													<time class="chi-time" datetime><?php echo get_the_date(
							...
							?>
									...
									<div class="card chi-card--borner-none chi-card">
										...
										<div class="card-body chi-card-body">
											...
											<strong class="chi-name-title"><?php echo get_post_field(
																												"doctoral_degrees_and_name_doctoral_degrees_and_name",
																												$advert->ID
																											) ?>
