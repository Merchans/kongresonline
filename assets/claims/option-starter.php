...
<main class="chi-category-bg">
	<div class="container">
		...
		<div class="row">
			<div class="<?php if ( count( $advertising_ids ) > 0 && ! empty( $advertising_ids ) ) {
				echo 'col-md-9';
			} else {
				echo 'col-md-12';
			} ?> chi-video-section">
				   ...
				   class="chi-category__link"><?php echo get_the_category( $advert->ID )[0]->slug ?></a>
											...
											<div class="card-body chi-card-body">
												<div class="text-left"><a
															href="<?php echo get_permalink( $advert->ID ) ?>"
							...
							foreach ( $adverts as $advert ) {
								if ( (string) $advert->post_type == "chi_video" ) {
									...
									<div class="card chi-card--borner-none chi-card">
										...
										<div class="card-body chi-card-body">
											<a href="<?php echo get_permalink( $advert->ID ) ?>"><h6
														class="card-title chi-card-title"><?php echo $advert->post_title ?></h6>
											</a>
											<strong
