...
<head>
	...
	<?php if ( get_post( get_the_ID() )->post_name == "czech-unbranded-risk-calculator" ) : ?>
		<meta charset="utf-8"/>
		<meta name="viewport"
		...
		<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/risk-calculator/css/style.css"
			  type="text/css"/>
		<link rel="stylesheet"
			  href="<?php echo get_stylesheet_directory_uri(); ?>/css/risk-calculator/css/swiper.min.css"
			  type="text/css"/>
		<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/risk-calculator/jquery-3.2.1.min.js"
				type="text/javascript"></script>
		<script type="text/javascript"
				src="<?php echo get_stylesheet_directory_uri(); ?>/js/risk-calculator/iscroll.js"></script>
		<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/risk-calculator/script.js"></script>
		<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/risk-calculator/baseScript.js"></script>
		<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/risk-calculator/jquery.touchSwipe.min.js"></script>
		<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/risk-calculator/jquery.tap.js"></script>
		<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/risk-calculator/swiper.min.js"></script>
	<?php endif ?>
