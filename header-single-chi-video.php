...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light chi-bg-light chi-navbar-nav chi-pb-0">
        <div class="chi-category-logo">
            <a href="<?php echo get_chi_make_specilal_form_category() ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/category-dianews-logo.png" alt="dianews"></a>
        </div>
