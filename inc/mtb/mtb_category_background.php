			...
			*/
			public function add_category_background( $taxonomy ) { ?>
				<div class="form-field term-group">
					...
					<input type="hidden" id="category-backgound-id" name="category-backgound-id"
						   class="custom_media_url" value="">
					<div id="category-backgound-wrapper"></div>
					<p>
						<input type="button" class="button button-secondary ct_tax_media_button_background"
							   id="ct_tax_media_button_background" name="ct_tax_media_button_background"
...
//		$CHI_CATEGORY_BACKGROUND->init();
	...
	function chi_special_background() {
		...
		$chi_special_background = wp_get_attachment_image_src( get_term_meta( $id, "category-backgound-id", true ), 'small' )[0];
