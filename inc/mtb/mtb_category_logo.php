			...
			*/
			public function add_category_image( $taxonomy ) { ?>
				<div class="form-field term-group">
					...
					<input type="hidden" id="category-image-id" name="category-image-id" class="custom_media_url"
						   value="">
					<div id="category-image-wrapper"></div>
					<p>
						<input type="button" class="button button-secondary ct_tax_media_button_logon"
							   id="ct_tax_media_button_logon" name="ct_tax_media_button_logon"
							   value="<?php _e( 'Add Image', 'chi-templates' ); ?>"/>
						<input type="button" class="button button-secondary chi_tax_media_logo_remove"
							   id="chi_tax_media_logo_remove" name="chi_tax_media_logo_remove"
							   value="<?php _e( 'Remove Image', 'chi-templates' ); ?>"/>
					</p>
				</div>
				<?php
			}
...
//		}
		...
		$chi_special_logo = wp_get_attachment_image_src( get_term_meta( $id, "category-image-id", true ), 'small' )[0];
